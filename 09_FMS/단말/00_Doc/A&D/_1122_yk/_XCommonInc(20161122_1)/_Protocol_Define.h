...
typedef enum _enumSNSR_SUB // FMS 설비 세부 구분 ENUM
{
	...
	// -----------------------------------------
	// 전원감시 : 상전압Vr, 상전압Vs, 상전압Vt, 주파수 .. -- 세부 센서구분은 SNSR_IDX 컬럼을 활용
	eSNSRSUB_AI_Power=302,
...
#define SNSR_ID__FIRMWAREUP		9998   // [2016/10/18 ykhong] : TFMS_CTLHIST_DTL 테이블의 SNSR_ID 항목을 9998 로 채움
...
typedef enum _enumEQPOnOffRslt // 설비 제어단계에 대한 결과
{
	...
	// [2016/11/17 ykhong] : 알림요청
	eEQPOnOffRslt_RTUPWCtrllr_NotCnn,  // RTU-전원제어기 연결되어 있지 않아 수행할 수 없음.
